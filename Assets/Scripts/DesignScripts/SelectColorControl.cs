...
//选择飞机颜色控制
public class SelectColorControl : MonoBehaviour {
    ...
    void Start () {
        ...
        modelRender = RtCamera.Find("Models/MainCom").GetComponent<MeshRenderer>();
